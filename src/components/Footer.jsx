...
export function Footer() {
  return (
    <footer className="mt-32 flex-none border-t-1 border-zinc-400 bg-white px-4 shadow-md sm:px-8 dark:bg-zinc-900">
      <ContainerOuter>
        <div className="border-t border-zinc-100 pt-10 pb-16 dark:border-zinc-700/40">
          <div className="flex flex-col items-start justify-start gap-6 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-col justify-start gap-x-6 gap-y-1 text-sm font-medium text-zinc-800 dark:text-zinc-200">
